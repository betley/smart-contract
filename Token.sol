...
contract CBITToken is Ownable, ERC20 {
    ...
    // Token properties
    string public name = "Betley Token";                //Token name
    ...
    uint256 public hardCap = 15000 ether;
    ...
    function tokensale(address recipient) public payable {
        ...
        if ((now > preSaleStartTime) && (now < preSaleStartTime + 30 days)) {
    ...
    function getPrice() public view returns (uint256 result) {
        if ((now > preSaleStartTime) && (now < preSaleStartTime + 30 days) && (presaleTotalNumberTokenSold < _saleSupply)) {
            if ((now > preSaleStartTime) && (now < preSaleStartTime + 7 days)) {
                return 15000;
            } else if ((now >= preSaleStartTime + 7 days) && (now < preSaleStartTime + 14 days)) {
                return 13000;
            } else if ((now >= preSaleStartTime + 14 days) && (now < preSaleStartTime + 21 days)) {
                return 11000;
